...
public class FileDownloader {
    ...
    public static void downloadFile(@Nonnull String url, @Nonnull String directory) throws IOException {
        downloadFile(url, new File(directory));
    }

    public static void downloadFile(@Nonnull String url, @Nonnull File directory) throws IOException {
        downloadFile(new URL(url), directory);
    }
}
