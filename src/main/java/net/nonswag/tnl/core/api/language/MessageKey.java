...
public class MessageKey {
    ...
    @Nonnull
    public static MessageKey CHAT_MENTION = new MessageKey("chat-mention", true);
    @Nonnull
    public static MessageKey PREFIX = new MessageKey("prefix", true);
    @Nonnull
    public static MessageKey COLOR_1 = new MessageKey("color-1", true);
    @Nonnull
    public static MessageKey COLOR_2 = new MessageKey("color-2", true);
    @Nonnull
    ...
    @Nonnull
    public static MessageKey COMMAND_ERROR = new MessageKey("command-error");
    @Nonnull
    public static MessageKey TAB_COMPLETE_ERROR = new MessageKey("tab-complete-error");
    @Nonnull
    public static MessageKey CHAT_ERROR = new MessageKey("chat-error");
    @Nonnull
    ...
    @Nonnull
    public static MessageKey CONNECTING_TO_SERVER = new MessageKey("connecting-to-server");
    @Nonnull
    public static MessageKey UNKNOWN_SERVER = new MessageKey("unknown-server");
    @Nonnull
    public static MessageKey FAILED_TO_CONNECT_TO_SERVER = new MessageKey("failed-to-connect-to-server");
    @Nonnull
    public static MessageKey SERVER_IS_OFFLINE = new MessageKey("server-is-offline");
